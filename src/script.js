...
function searchOne() {
    ...
    let searchString = ingredientsArray.forEach(searchString => {
...
function searchtTwo() {
    ...
    for (const i in ingredientsArray) {
        // console.log(ingredientsArray[i])
        let searchString = ingredientsArray[i]
        let liShowArray = []
