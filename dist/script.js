...
function recipesCardsHtml() {
    ...
    for (var i = 0; i < recipes.length; i++) {
        ...
        // test funkts
        html += `<div class="card  ">`;
        html += `<img src=` + 'img.838e229f.png' + `class="card-img-top" alt = "..." > `;
        html += `< div class="card-body row overflow-hidden" > `;
        html += `< div class="card-row" > `;
        html += `< h5 class="card-title" > ${recipesName}  </h5 > `;
        html += `< div class="time" > `;
        html += `< h5 class="card-title" > <img src="../dist/img/vector.svg"> ${recipesTime} min</h5>`;
        html += `</div > `;
        html += `</div > `; // row
