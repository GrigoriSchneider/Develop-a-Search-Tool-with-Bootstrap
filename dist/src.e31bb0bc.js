...
var recipesModule = {
  ...
  recipesCardsHtml: function recipesCardsHtml() {
    var html = '';
    ...
    for (var i = 0; i < recipes.length; i++) {
      ...
      for (var j = 0; j < recipes[i].ingredients.length; j++) {
        ...
        this.ingredients.push(ingredientName); // devices array
  ...
  ///////////////////////////////////////
  // 
  on: function on(selector, eventType, cb) {
  ...
  filterArrayUnique: function filterArrayUnique(array, newArray) {
  ...
  ///////////////////////////////////////////
  // clear  array from duplicates
  recipesDropdown: function recipesDropdown() {
    ...
    this.elements.dropdownIngredients.innerHTML = html; // reset Arrays
  ...
  ///////////////////////////////////////////
  // 
  ingredientsDropdown: function ingredientsDropdown(filteredArray) {
    var html = "";
  ...
  filterFunction: function filterFunction(e) {
    var keyword = this.elements.inputIngredients.value.toLowerCase();
    console.log(keyword);
    var filteredArray = this.showIngredients.filter(function (ingredient) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  recipesModule.elements.inputIngredients.addEventListener('blur', function () {
